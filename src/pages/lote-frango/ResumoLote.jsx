...
export function ResumoLote() {
  ...
  const quantidadeAtualLoteFrango = cards?.total_aves_lote_frango ?? cards?.total_aves ?? 0
  const mortalidadeLoteMes = cards?.mortalidade_lote_frango_mes ?? 0
  const consumoTotalLoteFrango = cards?.consumo_total_kg ?? cards?.consumo_total ?? 0
